...
<section id="about-section" class="about container-fluid">
	<article class="container">
		<div class="py-4">
			...
			<div class="row">
				...
				<div class="col-md">
					...
					<?php while (have_rows('skillset', 38)):
         the_row(); ?>
					<div class="skill">
						<div class="clearfix">
						...
						<div class="gauge">
							<span class="amount" style="width: <?php the_sub_field(
           'skill_rating'
       ); ?>%"></span>
						</div>
					</div>
     ...
     endwhile; ?>
       ...
       38
   ); ?>" title="Read more">Read more&hellip;</a>
		</div>
...
<section id="portfolio-section" class="portfolio container-fluid">
	<article class="container">
     ...
     endwhile; ?>
			...
			<a class="btn" href="<?php the_permalink(
       36
   ); ?>" title="See more">See more&hellip;</a>
		</div>
				...
				<div class="col-md-8">
					<div class="news-item featured">
						<figure class="featured-img">
							...
							<?php if (
           $img[3] !== ''
       ): ?><figcaption><a href="<?php echo $imgs[3]; ?>" title="<?php echo $imgs[3]; ?>" target="_blank" rel="nofollow noopener"><?php echo $imgs[3]; ?></a></figcaption><?php endif; ?>
						</figure>
						<div class="captions">
							<h3><?php the_title(); ?></h3>
   ...
   ?>
			...
			<div class="row">
				<div class="col-md">
					<?php if (
         $emailaddress
     ): ?><p class="contact-point"><span>Email:</span>&nbsp;<a href="mailto:<?php echo $emailaddress; ?>" title="Email me"><?php echo $emailaddress; ?></a></p><?php endif; ?>
					...
					<ul class="social-links">
						<?php if (
          $facebook
      ): ?><li class="facebook"><a href="<?php echo $facebook; ?>" title="Twitter" target="_blank" rel="noopener nofollow"><i class="fab fa-facebook-f" aria-hidden="true"></i></a></li><?php endif; ?>
						<?php if (
          $twitter
      ): ?><li class="twitter"><a href="<?php echo $twitter; ?>" title="Twitter" target="_blank" rel="noopener nofollow"><i class="fab fa-twitter" aria-hidden="true"></i></a></li><?php endif; ?>
						<?php if (
          $pinterest
      ): ?><li class="pinterest"><a href="<?php echo $pinterest; ?>" title="Pinterest" target="_blank" rel="noopener nofollow"><i class="fab fa-pinterest-p" aria-hidden="true"></i></a></li><?php endif; ?>
						<?php if (
          $linkedin
      ): ?><li class="linkedin"><a href="<?php echo $linkedin; ?>" title="LinkedIn" target="_blank" rel="noopener nofollow"><i class="fab fa-linkedin-in" aria-hidden="true"></i></a></li><?php endif; ?>
					</ul>
					<?php endif; ?>
         ...
         '[contact-form-7 id="29" title="Footer Contact Form"]'
     ); ?>
				</div>
			</div>
