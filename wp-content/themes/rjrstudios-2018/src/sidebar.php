...
<aside class="sidebar py-4">
    ...
    <div class="post-nav">
        ...
        <a href="<?php the_permalink(
            36
        ); ?>" title="Back to projects"><div class="btn">Back to projects</div></a>
        <?php endif; ?>
        <a href="<?php the_permalink(
            6
        ); ?>" title="Back to articles"><div class="btn">Back to articles</div></a>
        <a href="<?php bloginfo(
            'url'
        ); ?>" title="Back to articles"><div class="btn">Back to homepage</div></a>
        <?php if (is_singular('post')): ?>
        ...
        <ul class="blogroll">
            ...
            <li class="clearfix">
                ...
                <div>
                    ...
                    <p>By Rob Randell on <span><?php echo the_time(
                        'M j, Y'
                    ); ?></span></p>
                </div>
            </li>
    ...
    <div class="sidebartags">
        ...
        <ul class="taglist clearfix">
            ...
            <li><a class="btn" href="<?php echo get_tag_link(
                $tag->term_id
            ); ?>" title="<?php echo $tag->name; ?>"><?php echo $tag->name; ?></a></li>
            <?php endforeach; ?>
        </ul>
    </div>
    <?php endif;
