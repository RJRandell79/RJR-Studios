...
function remove_scripts_styles_version($src)
{
    if (
        strpos($src, 'ver=') &&
        $src !==
            get_template_directory_uri() . '/style.css?ver=' . THEME_VERSION
    ) {
...
function fancy_title($str)
{
    ...
    elseif ($len == 2):
        $html =
            '<h1><span class="light-font">' .
            $arr[0] .
            '</span> <span class="primary-col">' .
            $arr[1] .
            '</span></h1>';
    elseif ($len == 3):
        $html =
            ...
            ' ' .
            $arr[1] .
            '</span><br /><span class="primary-col">' .
            $arr[2] .
            '</span></h1>';
    else:
        for ($x = 4; $x < $len; $x++):
...
function international_number_link($number, $country = 'uk')
{
    // Adds international dialling prefix for GB unless country value is overidden
    $codes = array(
        'austria' => 43,
        'belgium' => 32,
        'bulgaria' => 359,
...
{
    // Remove grammar from numeric figures and convert to float value
...
{
    // Show average read time of an article
        ...
        <form method="POST" action="options.php">
            ...
            <table>
                <tr>
                    ...
                    <td><input type="text" id="twitter_url" name="twitter_url" size="45" value="<?php echo esc_attr(
                ...
                <tr>
                    ...
                    <td><input type="text" id="facebook_url" name="facebook_url" size="45" value="<?php echo esc_attr(
                ...
                <tr>
                    ...
                    <td><input type="text" id="linkedin_url" name="linkedin_url" size="45" value="<?php echo esc_attr(
                ...
                <tr>
                    ...
                    <td><input type="text" id="pinterest_url" name="pinterest_url" size="45" value="<?php echo esc_attr(
                ...
                <tr>
                    ...
                    <td><input type="text" id="phone_no" name="phone_no" size="45" value="<?php echo esc_attr(
                        get_option('phone_no')
                    ); ?>" /></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="text" id="email_address" name="email_address" size="45" value="<?php echo esc_attr(
                        get_option('email_address')
                    ); ?>" /></td>
                </tr>

                <tr>
                    <td><label for="analytics">Analytics </label></td>
                    <td><textarea id="analytics" name="analytics" rows="5" cols="75"><?php echo esc_attr(
                        get_option('analytics')
                    ); ?></textarea></td>
                </tr>
